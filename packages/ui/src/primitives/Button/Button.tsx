...
const buttonVariants = cva(
    ...
    "disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-primary text-white shadow-sm shadow-primary/30 hover:bg-primary-600 hover:shadow-md hover:shadow-primary/40 active:scale-[0.98]",
        secondary:
          "glass text-text-primary hover:bg-primary-50 active:scale-[0.98]",
        ghost: "hover:bg-primary-50 text-text-primary active:scale-[0.98]",
